...
export default function UploadMediaPage() {
  ...
  const { loading, error, success } = useSelector((state) => state.media);
          ...
          <div className="space-y-4">
              ...
              {uploadMethod === 'file' ? (
                <>
                  {!file ? (
                    ...
                    >
                      <CloudUpload size={48} className="text-blue-600 mx-auto mb-4" />
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mb-3">
                    <TextField
                      ...
                      startIcon={<Tag size={20} className="text-blue-600" />}
                      fullWidth
                    />
                    <Button
                      type="button"
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                type="submit"
                disabled={loading}
                startIcon={!loading && <CloudUpload size={20} />}
                size="large"
                sx={{ 
                  flex: 1, 
                  backgroundColor: '#144ae9', 
              ...
              <Link href="/admin/media" className="no-underline flex-1">
                <Button
                  variant="outlined"
                  size="large"
                  disabled={loading}
...
//               startIcon={!uploadLoading && <CloudUpload size={20} />}
//               size="large"
//               sx={{ 
//                 flex: 1, 
//                 backgroundColor: '#144ae9', 
...
//     <div className="p-4 md:p-6 max-w-5xl mx-auto">
//       {/* HEADER */}
//       {uploadLoading && <div className="fixed inset-0 z-[9999]">
//           <Loader message={"Uploading..."} />
//         </div>}
//       <div className="flex items-center gap-4 mb-6">
//         <Link href="/admin/media" className="no-underline">
