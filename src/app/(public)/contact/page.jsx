      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            {contactInfo.map((info, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-2xl p-6 border-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                  style={{ borderColor: colors.green }}
                >
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-xl" style={{ backgroundColor: `${colors.saffron}20` }}>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl border-2 p-6 md:p-8" style={{ borderColor: colors.green }}>
              <div className="mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-11 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-offset-2 transition-all ${
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-offset-2 transition-all resize-none ${
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 rounded-xl font-bold text-white text-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3"
        ...
        {/* Map Section */}
        <div className="mt-12">
          <div className="bg-white rounded-2xl border-2 overflow-hidden" style={{ borderColor: colors.green }}>
