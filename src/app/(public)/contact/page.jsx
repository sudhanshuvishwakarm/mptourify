      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl border-2 p-6 md:p-8 border-[#117307]">
              <div className="mb-6">
                <h2 className="text-2xl md:text-3xl font-bold mb-2 text-[#2E3A3B]">
                  Send Us a Message
                </h2>
                <p className="opacity-70 text-[#2E3A3B]">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Name */}
                <div>
                  <label className="block text-sm font-bold mb-2 text-[#2E3A3B]">
                    Full Name *
                  </label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 opacity-50 text-[#2E3A3B]" size={20} />
                    <input
                      type="text"
                      name="name"
                      value={formData.name}
                      onChange={handleChange}
                      className={`w-full pl-11 pr-4 py-3 border-2 rounded-md transition-all focus:outline-none focus:!border-[#0A5C08] ${
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <AtSign className="absolute left-3 top-1/2 -translate-y-1/2 opacity-50 text-[#2E3A3B]" size={20} />
                      <input
                        type="email"
                        name="email"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Phone className="absolute left-3 top-1/2 -translate-y-1/2 opacity-50 text-[#2E3A3B]" size={20} />
                      <input
                        type="tel"
                        name="phone"
                ...
                <div>
                  ...
                  <div className="relative">
                    <FileText className="absolute left-3 top-1/2 -translate-y-1/2 opacity-50 text-[#2E3A3B]" size={20} />
                    <input
                      type="text"
                      name="subject"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className={`w-full pl-5 pr-4 py-3 border-2 rounded-md transition-all focus:outline-none focus:!border-[#0A5C08] ${
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 rounded-md font-bold text-white text-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3 bg-[#117307] hover:bg-[#0d5c06]"
                >
                  {loading ? (
                    <Loader/>
                  ) : (
          ...
          <div className="lg:col-span-1 space-y-6">
            {contactInfo.map((info, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-xl p-6 border-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-[#117307]"
                >
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-md bg-[#117307]/20">
                      <Icon size={24} className="text-[#117307]" />
                    </div>
                    <div className="flex-1">
                      <h3 className="font-bold text-lg mb-1 text-[#2E3A3B]">
                        {info.title}
                      </h3>
                      <p className="font-semibold mb-1 text-[#117307]">
                        {info.content}
                      </p>
                      <p className="text-sm font-semibold text-[#2E3A3B]">
                        {info.subContent}
                      </p>
                    </div>
                  </div>
            ...
            {/* Quick Facts */}
            <div className="bg-white rounded-xl p-6 border-2 border-[#117307]">
              <h3 className="font-bold text-lg mb-4 flex items-center gap-2 text-[#2E3A3B]">
                <div className="p-3 rounded-md bg-[#117307]/20">
                  <Clock size={24} className="text-[#117307]" />
                </div>
                Office Hours
              </h3>
              <div className="space-y-2 text-sm text-[#2E3A3B]">
