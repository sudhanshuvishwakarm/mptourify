...
export async function GET(request, context) {
    try {
        ...
        let query = { block: { $regex: decodedBlockName, $options: 'i' } };
        ...
        const panchayats = await GramPanchayat.find(query)
            .select('name slug district block coordinates status basicInfo.population basicInfo.area headerImage createdAt')
