    ...
    try {
        ...
        if (contentType && contentType.includes('multipart/form-data')) {
            ...
            if (uploadMethod === 'file' && file) {
                ...
                if (existingPanchayat.headerImage && existingPanchayat.headerImage.includes('cloudinary')) {
                    try {
                        let publicId;
                        const url = existingPanchayat.headerImage;
                        ...
                        if (publicId) {
                            console.log(`Deleting old panchayat header image from Cloudinary: ${publicId}`);
                        ...
                        console.error('Error deleting old panchayat header image:', cloudError);
                    }
                }
                ...
                if (existingPanchayat.headerImage && 
                    existingPanchayat.headerImage.includes('cloudinary') && 
                    existingPanchayat.headerImage !== fileUrl) {
                    try {
                        let publicId;
                        const url = existingPanchayat.headerImage;
