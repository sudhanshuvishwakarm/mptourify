...
//     {
//       name: "Maheshwar Fort",
//       image: "public/images/homeabout1.webp/images/maheshwar.jpg",
//     },
//     {
//       name: "Kanha Tiger Reserve",
...
//                 <span style={{ color: colors.saffron }}>Digitally</span>
//                 <br />
//                 <span style={{ color: colors.darkGray }}>Transforming</span>
//                 <br />
//                 <span style={{ color: colors.green }}>Tourism</span>
//               </h2>
...
//                   <div key={idx} className="flex items-center gap-3">
//                     <div className="w-2 h-2 rounded-full" style={{ backgroundColor: colors.saffron }} />
//                     <span style={{ color: colors.darkGray }}>{feature}</span>
//                   </div>
//                 ))}
//               </div>
//             </div>
