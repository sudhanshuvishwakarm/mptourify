...
export default function TranslationProvider({ children }) {
  ...
  const supportedLanguages = 'en,hi,gu,mr,ta,te,kn,ml,bn,pa,or,as,ur';
    ...
    window.googleTranslateElementInit = function() {
      ...
      try {
        new window.google.translate.TranslateElement(
          {
            pageLanguage: 'en',
            includedLanguages: supportedLanguages, // Updated to include all languages
            autoDisplay: false,
          },
  ...
  }, [scriptLoaded, supportedLanguages]);
  ...
  const triggerGoogleTranslate = (targetLang) => {
    const checkAndTranslate = (attempts = 0) => {
      ...
      if (selectElement) {
        ...
        if (selectElement.querySelector(`option[value="${targetLang}"]`)) {
          ...
          console.warn(`Language ${targetLang} not available in Google Translate`);
          setIsTranslating(false);
        }
      } else {
